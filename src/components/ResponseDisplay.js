            ...
            {sources.map((source, index) => {
              ...
              return (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3.5 bg-white dark:bg-slate-800/80 hover:bg-teal-50 dark:hover:bg-slate-700/80 rounded-xl border border-slate-200/70 dark:border-slate-700/50 shadow-sm transition-all duration-200 group hover:border-teal-200 dark:hover:border-teal-800/70 hover:shadow-md"
                >
                  <div className="flex items-center mb-2">
                    <div className="w-5 h-5 rounded-full bg-slate-100 dark:bg-slate-700 p-0.5 flex items-center justify-center mr-2 overflow-hidden">
                      <img
                        src={faviconUrl}
                        alt={`${domain} favicon`}
                  ...
                  <p className="text-sm text-slate-700 dark:text-slate-300 leading-snug group-hover:text-teal-600 dark:group-hover:text-teal-400 transition-colors duration-150 font-medium">
